...
vis.binds["vis-flexcontrol"] = {
    ...
    showVersion: function () {
        if (vis.binds["vis-flexcontrol"].version) {
            ...
            vis.binds["vis-flexcontrol"].version = null;
        }
    },
    createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds["vis-flexcontrol"].createWidget(widgetID, view, data, style);
            }, 100);
        }
        ...
        text += '<!-- Minus -->';
        text += '<div class="vis-widget vis-flexcontrol-button" style="width: 20px; height: 20px; position: absolute; left: 120px; top: 40px; z-index: 3; font-size: medium;">';
        ...
        text += '<!-- Plus -->';
        text += '<div class="vis-widget vis-flexcontrol-button" style="width: 20px; height: 20px; position: absolute; left: 145px; top: 40px; z-index: 3; font-size: medium;">';
...
vis.binds["vis-flexcontrol"].showVersion();